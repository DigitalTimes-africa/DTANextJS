...
export default function TagListSection(){
    return(
        <div className="flex flex-row flex-wrap 2xsm:gap-0 gap-6">
            ...
            <div className='flex xlg:flex-row flex-col flex-wrap gap-4 xlg:flex-nowrap xlg:justify-between xlg:mb-4'>
            ...
            <div className="md:basis-1/2 pb-8" >
            <div className='flex xlg:flex-row flex-col flex-wrap gap-4 2xsm:flex-nowrap xlg:justify-between xlg:mb-4'>
