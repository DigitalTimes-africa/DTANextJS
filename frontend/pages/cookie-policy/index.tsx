...
export default function CookiePolicy() {
    return(
        <RootLayout>
            <Heading title={'Digital Times - Cookie Policy'} name={'description'} content={'Digital Times Africa is a multimedia agency that provides a platform promoting African innovation. We curate relevant and credible content for startups, entrepreneurs and technology lovers in Africa.'} />
                        ...
                        <div className="flex flex-row justify-center">
                            <div className="xmd:w-8/12 xsm:w-10/12 legal-styles">
                                ...
                                <p className="pt-4">This Cookies Policy explains what Cookies are and how We use them. You should read this policy so You can
                                    ...
                                    href="https://www.freeprivacypolicy.com/free-cookies-policy-generator/" target="_blank">Cookies Policy
                                    Generator</Link>.</p>
                                ...
                                <ul>
                                    ...
                                    &quot;Our&quot; in this Cookies Policy) refers to Digital Times Africa, GM-057-7751, 14 Bombay St. - Accra, Ghana.</li>
                                    ...
                                    <li><strong>Website</strong> refers to Digital Times, accessible from <Link href="/"
                                        rel="external nofollow noopener" target="_blank"> https://www.digitaltimes.africa</Link></li>
                                ...
                                <ul>
                                    ...
                                    <p>Purpose: These Cookies are essential to provide You with services available through the Website and to
                                        enable
                                        You to use some of its features. They help to authenticate users preferences and prevent fraudulent use of
                                        user
                                        details.
                                    ...
                                    <p>Purpose: These Cookies allow us to remember choices You make when You use the Website, such as remembering
                                        your ad pop-up preferences. We also collect or store your personal information (for example, your email
                                        address) to simply enable us to send
                                        newsletters and other Digital Times related content, as per your preference choice. The main purpose of
                                        these
                                        Cookies is to provide You with a more personal
                                        experience and to avoid You having to choosing your preferences every time You use the Website.
                                    </p>

                                    <p>If you share online Digital Times content with friends through social networks – such as Facebook and
                                        Twitter -
                                        you may be
                                        sent cookies from these websites. We don’t control the setting of these cookies, so please check third party
                                ...
                                <ul>
                                    <li><span><strong>Forms related cookies</strong></span>
                                    <p>
                                        When you submit data to through a form such as those found on contact pages or comment forms cookies may be
                                        set to
                                        remember your user details for future correspondence.</p>
                                    </li>

                                    <li>
                                    <span><strong>Third Party Cookies</strong></span>
                                    ...
                                    <p>This site uses Google Analytics which is one of the most widespread and trusted analytics solution on the
                                        web
                                        for helping us to understand how you use the site and ways that we can improve your experience. These
                                        cookies
                                    ...
                                    <p>
                                        Several partners advertise on our behalf and affiliate tracking cookies simply allow us to see if our
                                        customers
                                        have come to the site through one of our partner sites so that we can credit them appropriately and where
                                        applicable allow our affiliate partners to provide any bonus that they may provide you for making a
                                        purchase.
                                    </p>
                                    <p>
                                        We also use social media buttons and/or plugins on this site that allow you to connect with your social
                                        network
                                        in various ways. For these to work the following social media sites including; Twitter, Facebook, will set
                                        cookies through our site which may be used to enhance your profile on their site or contribute to the data
                                        they
                                ...
                                <ul>
                                    <li><span>For the Chrome web browser, please visit this page from Google: <Link
                                        href="https://support.google.com/accounts/answer/32050" rel="external nofollow noopener"
                                        target="_blank">https://support.google.com/accounts/answer/32050</Link></span>
                                    </li>
                                    <li><span>For the Internet Explorer web browser, please visit this page from Microsoft: <Link
                                        href="http://support.microsoft.com/kb/278835" rel="external nofollow noopener"
                                        target="_blank">http://support.microsoft.com/kb/278835</Link></span>
                                    </li>
                                    <li><span>For the Firefox web browser, please visit this page from Mozilla: <Link
                                        href="https://support.mozilla.org/en-US/kb/delete-cookies-remove-info-websites-stored"
                                        rel="external nofollow noopener"
                                        target="_blank">https://support.mozilla.org/en-US/kb/delete-cookies-remove-info-websites-stored</Link></span>
                                    </li>
                                    <li>
                                    <span>For the Safari web browser, please visit this page from Apple: <Link
                                        href="https://support.apple.com/guide/safari/manage-cookies-and-website-data-sfri11471/mac"
                                        rel="external nofollow noopener"
                                        target="_blank">https://support.apple.com/guide/safari/manage-cookies-and-website-data-sfri11471/mac</Link>
                                    </span>
                                    </li>
                                </ul>
