...
export default function Terms() {
    return(
        <RootLayout>
            <Heading title={'Digital Times - Terms and Conditions'} name={'description'} content={'Digital Times Africa is a multimedia agency that provides a platform promoting African innovation. We curate relevant and credible content for startups, entrepreneurs and technology lovers in Africa.'} />
                    ...
                    <div className="mb-20 pt-12">
                        <div className="flex flex-row justify-center">
                            <div className="xmd:w-8/12 xsm:w-10/12 legal-styles">
                                ...
                                <ul>
                                    <li>
                                    <span><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with
                                        a
                                    ...
                                    <li>
                                    <span><strong>Terms and Conditions</strong> (also referred as &quot;Terms&quot;) mean these Terms and Conditions
                                        that form the entire agreement between You and the Company regarding the use of the Service.</span>
                                    </li>
                                    <li>
                                    <span><strong>Third-party Social Media Service</strong> means any services or content (including data,
                                        information,
