...
from wagtail.blocks import RichTextBlock, CharBlock, StructBlock, DateBlock
# from wagtail.core.blocks.field_block import BlockField
from wagtail.admin.panels import FieldPanel

class CustomNewsBlock(StructBlock):
    """Custom News Block."""

    title = CharBlock(required=True)
    date = DateBlock(required=True)
    author = CharBlock(required=True)
    ...
    def clone(self):
        return self.__class__(
            ...
            label=self.label,
            **{name: child.block.clone() for name, child in self.children.items()}
        )
